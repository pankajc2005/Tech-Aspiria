            ...
            generativeModel.generateContentStream(inputContent).collect { chunk ->
                chunk.text?.let {
                    if (it.trim().isNotEmpty()) {
                        // Process the text to enhance clarity for blind users
                        val enhancedText = it
